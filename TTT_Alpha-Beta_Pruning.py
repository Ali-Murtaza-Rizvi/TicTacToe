...
class AI_Player:
    ...
    def get_move(self, game):
        if len(game.available_moves()) == 9:
            ...
            square = self.minimax(game, self.letter, alpha=-math.inf, beta=math.inf)['position']
        return square
    ...
    def minimax(self, state, player, alpha, beta):
        ...
        for possible_move in state.available_moves():
            ...
            sim_score = self.minimax(state, other_player, alpha, beta)  # Simulate a game after move
...
def play(game, o_player, print_game=True):
    if print_game:
        game.print_board()
...
if __name__ == '__main__':
    ...
    o_player = AI_Player('O')  # AI playing as 'O'
